        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExhibitionDate = table.Column<DateTime>(type: "date", nullable: false),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DeliveryCountry", x => x.ID);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductID = table.Column<int>(type: "int", nullable: true),
                    CountOfProducts = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MembersProducts", x => x.ID);
                    table.ForeignKey(
                        name: "FK_MembersProducts_Categories",
                        column: x => x.ProductID,
                        principalTable: "Products",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_MembersProducts_Products",
                        column: x => x.MemberID,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DeliveryCountry_ManufacturerID",
                table: "DeliveryCountry",
                column: "ManufacturerID");

            migrationBuilder.CreateIndex(
                name: "IX_DeliveryCountry_ProductID",
                table: "DeliveryCountry",
                column: "ProductID");
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__Members__A9D1053454B5C4AE",
                table: "Members",
                column: "Email",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_MembersProducts_MemberID",
                table: "MembersProducts",
                column: "MemberID");

            migrationBuilder.CreateIndex(
                name: "IX_MembersProducts_ProductID",
                table: "MembersProducts",
                column: "ProductID");
