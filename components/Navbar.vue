...
<nav class="w-full p-4 bg-transparent">
    ...
    <div class="hidden md:block">
        ...
        <ul class="flex space-x-8 text-sm font-sans">
            <li><nuxt-link to="/releases" @click="isOpen = false" exact active-class="text-blue-300" class="text-gray-100 hover:text-black px-3 text-md">
            ...
            <li><nuxt-link to="/collection" @click="isOpen = false" active-class="text-blue-300" class="text-gray-100 hover:text-black text-md px-3">
                Men</nuxt-link></li>
            <li><nuxt-link to="/users" @click="isOpen = false" active-class="text-blue-300" class="text-gray-100 hover:text-black text-md px-3">
                Women</nuxt-link></li>
            <li><nuxt-link to="#" @click="isOpen = false" active-class="text-blue-300" class="text-gray-100 hover:text-black text-md px-3">
                Kids</nuxt-link></li>
            <li><nuxt-link to="#" @click="isOpen = false" active-class="text-blue-300" class="text-gray-100 hover:text-black text-md px-3">
    ...
    <aside class="p-5 transform top-0 left-0 w-64 bg-white fixed h-full overflow-auto ease-in-out transition-all duration-300 z-30" :class="isOpen ? 'translate-x-0' : '-translate-x-full'">
        ...
        <ul class="divide-y font-sans">
            <li><nuxt-link to="/" @click="isOpen = false" exact active-class="text-blue-300" class="text-gray-300 hover:text-white px-3 text-md">
                New Releases</nuxt-link></li>
            <li><nuxt-link to="/releases" @click="isOpen = false" active-class="text-blue-300" class="text-gray-50 hover:text-blue-200 text-md px-3">
                Men</nuxt-link></li>
            <li><nuxt-link to="/users" @click="isOpen = false" active-class="text-blue-300" class="text-gray-50 hover:text-blue-200 text-md px-3">
                Women</nuxt-link></li>
            <li><nuxt-link to="#" @click="isOpen = false" active-class="text-blue-300" class="text-gray-50 hover:text-blue-200 text-md px-3">
                Kids</nuxt-link></li>
            <li><nuxt-link to="#" @click="isOpen = false" active-class="text-blue-300" class="text-gray-50 hover:text-blue-200 text-md px-3">
                Collection</nuxt-link></li>
            <li><nuxt-link to="#" @click="isOpen = false" active-class="text-blue-300" class="text-gray-50 hover:text-blue-200 text-md px-3">
...
<!-- 
<nuxt-link to="/" exact active-class="text-blue-300" class="text-gray-300 hover:text-white px-3 text-md">
                New Releases</nuxt-link>

                <nuxt-link to="/releases" active-class="text-blue-300" class="text-gray-50 hover:text-blue-200 text-md px-3">
                Men</nuxt-link>

                <nuxt-link to="/users" active-class="text-blue-300" class="text-gray-50 hover:text-blue-200 text-md px-3">
                Women</nuxt-link>

                <nuxt-link to="#" active-class="text-blue-300" class="text-gray-50 hover:text-blue-200 text-md px-3">
                Kids</nuxt-link>
